  ...
  return (
    ...
    >
      ...
      <div>
        ...
        />
        {errors.phone && (
          <p className="text-[#F87171] mt-1 text-xs pl-1">{errors.phone}</p>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          />
          {errors.city && (
            <p className="text-[#F87171] mt-1 text-xs pl-1">{errors.city}</p>
          )}
        </div>
        <div>
          <label
          ...
          />
          {errors.state && (
            <p className="text-[#F87171] mt-1 text-xs pl-1">{errors.state}</p>
          )}
        </div>
        <div>
          <label
          ...
          />
          {errors.zip && (
            <p className="text-[#F87171] mt-1 text-xs pl-1">{errors.zip}</p>
          )}
        </div>
      </div>
